...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROMPTKD.SNS_RHO = 0.5
    cfg.TRAINER.PROMPTKD.SNS_RANK = 4
    cfg.TRAINER.PROMPTKD.SNS_PCA_RANK = 32
    cfg.TRAINER.PROMPTKD.SNS_SEMANTIC_RANK = 0
    cfg.TRAINER.PROMPTKD.SNS_MAX_SAMPLES = 8192
    cfg.TRAINER.PROMPTKD.SNS_CENTER = True
    cfg.TRAINER.PROMPTKD.SNS_PCA_NITER = 4
    cfg.TRAINER.PROMPTKD.SNS_CACHE = True
    cfg.TRAINER.PROMPTKD.SNS_RECOMPUTE = False
    cfg.TRAINER.PROMPTKD.SNS_CACHE_DIR = "sns_cache"
    cfg.TRAINER.PROMPTKD.SNS_EPS = 1e-6
    cfg.TRAINER.PROMPTKD.SNS_STRICT = True
    cfg.TRAINER.PROMPTKD.SNS_DEBUG = True
    cfg.TRAINER.PROMPTKD.SNS_DIAG_FILENAME = "sns_diagnostics.json"
